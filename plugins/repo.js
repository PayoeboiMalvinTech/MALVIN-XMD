...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/kingmalvn/MALVIN-XMD';
    ...
    try {
        ...
        const formattedInfo = `*𝐇𝐞𝐥𝐥𝐨 𝐭𝐡𝐞𝐫𝐞 𝐌𝐀𝐋𝐕𝐈𝐍 𝐗𝐌𝐃 𝐖.𝐀 𝐁𝐨𝐭 𝐔𝐬𝐞𝐫! 👋* 
